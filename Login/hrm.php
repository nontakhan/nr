...
<div class="container-fluid">
    ...
    <div class="row clearfix">
                ...
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-hover dashboard-task-infos">
                            <thead>
                                <tr><td><span class="style3">อัพเดทระบบ HRM</span></td></tr>
                            </thead>
                            <tbody>
                                <tr><td><span class="style2">สิทธิการเข้าใช้งาน (สำหรับเจ้าหน้าที่ฝ่ายบุคคล/หัวหน้ากลุ่มงาน)</span></td></tr>
                                <tr><td><span class="text-success">ประกาศ ณ.วันที่ 31-10-2018 13:39:51</span></td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <div class="card">
                <div class="header">
                    <h2 align="center">LOGIN<br><span class="style4 font-16">(สำหรับเจ้าหน้าที่ฝ่ายบุคคล/หัวหน้ากลุ่มงาน)</span></h2>
                </div>
                <div class="body">
                    <form role="form" method="post" action="../hrm/check_login.php">
                        <fieldset>
                            <div class="form-group"  >
                                <input class="form-control" placeholder="ชื่อผู้ใช้งานระบบ" autocomplete=off name="username" autofocus required>
                            </div>
                            <div class="form-group">
                                <input class="form-control" placeholder="รหัสผ่าน" autocomplete=off name="password" type="password" required>
                            </div>
