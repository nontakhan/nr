...
<div class="container-fluid">
    ...
    <div class="row clearfix">
                ...
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-hover dashboard-task-infos">
                            <thead>
                                <tr><td><span class="style3">ฟังก์ชั่นการใช้งาน</span></td></tr>
                            </thead>
                            <tbody>
                                <tr><td><span class="style2">                     
                                1.บันทึกข้อมูลทางการเงินบุคลากร<br>
                                2.ออกหนังสือรับรองเงินเดือน<br>
                                3.ออกหนังสือสรุปเงินได้<br>
                                สิทธิการเข้าใช้งาน (สำหรับเจ้าหน้าที่ งานการเงิน)</span></td></tr>
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <div class="card">
                <div class="header">
                    <h2 align="center">LOGIN<br><span class="style4 font-16">(สำหรับเจ้าหน้าที่ งานการเงิน)</span></h2>
                </div>
                <div class="body">
                    <form role="form" method="post" action="../emoney/check_login.php">
                        <fieldset>
